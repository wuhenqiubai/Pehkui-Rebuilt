 ...
 */
public class ScaleRuleLoader extends SimplePreparableReloadListener<Map<Identifier, JsonElement>>
{
	...
	@Override
	protected void apply(Map<Identifier, JsonElement> rawJson, ResourceManager manager, ProfilerFiller profiler)
	{
