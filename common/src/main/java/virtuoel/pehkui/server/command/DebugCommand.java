...
public class DebugCommand
{
			...
			builder
				.then(Commands.literal("debug")
					...
					.then(Commands.literal("garbage_collect")
						.executes(context ->
						{
							final Packet<?> packet = Platform.INSTANCE.createClientboundPacket(new DebugPayload(PacketType.GARBAGE_COLLECT));
	...
	private static int runMixinTests(CommandContext<CommandSourceStack> context) throws CommandSyntaxException
	{
		...
		{
			final Packet<?> packet = Platform.INSTANCE.createClientboundPacket(new DebugPayload(PacketType.MIXIN_AUDIT));
